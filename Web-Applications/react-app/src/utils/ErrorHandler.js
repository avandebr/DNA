...
const ALREADY_REQUESTED = "You have already requested access to this patent. Please go in your requests to manage it";
const NOT_REQUESTABLE = "You cannot request access for this file";
